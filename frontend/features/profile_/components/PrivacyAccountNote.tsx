export function PrivacyAccountNote() {
  return (
    <section
      ...
      className="rounded-3xl border border-zinc-200 bg-white/70 p-4 shadow-sm sm:p-5"
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-zinc-100 text-zinc-800">
          <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5">
            <path fill="currentColor" d="M12 2 5 5v6c0 4.4 2.9 8.5 7 9.8 4.1-1.3 7-5.4 7-9.8V5l-7-3Zm1 6v4h3v2h-5V8h2Z" />
          </svg>
        </span>
        <div>
          <h2 id="privacy-account-heading" className="text-lg font-semibold text-zinc-950">
